...
class google_compute_autoscaler(_resource): pass
compute_autoscaler = google_compute_autoscaler

class google_compute_address(_resource): pass
compute_address = google_compute_address

class google_compute_backend_bucket(_resource): pass
compute_backend_bucket = google_compute_backend_bucket

class google_compute_backend_service(_resource): pass
compute_backend_service = google_compute_backend_service

class google_compute_disk(_resource): pass
compute_disk = google_compute_disk

class google_compute_snapshot(_resource): pass
compute_snapshot = google_compute_snapshot

class google_compute_firewall(_resource): pass
compute_firewall = google_compute_firewall

class google_compute_forwarding_rule(_resource): pass
compute_forwarding_rule = google_compute_forwarding_rule

class google_compute_global_address(_resource): pass
compute_global_address = google_compute_global_address

class google_compute_global_forwarding_rule(_resource): pass
compute_global_forwarding_rule = google_compute_global_forwarding_rule

class google_compute_health_check(_resource): pass
compute_health_check = google_compute_health_check

class google_compute_http_health_check(_resource): pass
compute_http_health_check = google_compute_http_health_check

class google_compute_https_health_check(_resource): pass
compute_https_health_check = google_compute_https_health_check

class google_compute_image(_resource): pass
...
class google_compute_network(_resource): pass
...
class google_compute_region_autoscaler(_resource): pass
compute_region_autoscaler = google_compute_region_autoscaler

class google_compute_region_backend_service(_resource): pass
...
class google_compute_route(_resource): pass
compute_route = google_compute_route

class google_compute_router(_resource): pass
...
class google_compute_ssl_certificate(_resource): pass
compute_ssl_certificate = google_compute_ssl_certificate

class google_compute_subnetwork(_resource): pass
compute_subnetwork = google_compute_subnetwork

class google_compute_target_http_proxy(_resource): pass
compute_target_http_proxy = google_compute_target_http_proxy

class google_compute_target_https_proxy(_resource): pass
compute_target_https_proxy = google_compute_target_https_proxy

class google_compute_target_tcp_proxy(_resource): pass
compute_target_tcp_proxy = google_compute_target_tcp_proxy

class google_compute_target_ssl_proxy(_resource): pass
compute_target_ssl_proxy = google_compute_target_ssl_proxy

class google_compute_target_pool(_resource): pass
compute_target_pool = google_compute_target_pool

class google_compute_url_map(_resource): pass
compute_url_map = google_compute_url_map

class google_compute_vpn_gateway(_resource): pass
compute_vpn_gateway = google_compute_vpn_gateway

class google_compute_vpn_tunnel(_resource): pass
...
class google_sourcerepo_repository(_resource): pass
sourcerepo_repository = google_sourcerepo_repository

class google_spanner_instance(_resource): pass
spanner_instance = google_spanner_instance

class google_spanner_database(_resource): pass
spanner_database = google_spanner_database

class google_sql_database(_resource): pass
sql_database = google_sql_database
...
class google_pubsub_topic(_resource): pass
pubsub_topic = google_pubsub_topic

class google_pubsub_subscription(_resource): pass
