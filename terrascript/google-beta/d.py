...
class google_compute_ha_vpn_gateway(terrascript.Data):
    pass


class google_compute_health_check(terrascript.Data):
    pass
...
class google_kms_secret_asymmetric(terrascript.Data):
    pass
...
class google_monitoring_istio_canonical_service(terrascript.Data):
    pass
...
class google_secret_manager_secret(terrascript.Data):
    pass
