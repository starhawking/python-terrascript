...
def test_resource_import():
    ...
    from terrascript.resource.cloudflare.cloudflare import cloudflare_access_ca_certificate

    from terrascript.resource.cloudflare.cloudflare import cloudflare_access_group

    from terrascript.resource.cloudflare.cloudflare import cloudflare_access_identity_provider

    from terrascript.resource.cloudflare.cloudflare import cloudflare_access_mutual_tls_certificate
    ...
    from terrascript.resource.cloudflare.cloudflare import cloudflare_access_service_token
    ...
    from terrascript.resource.cloudflare.cloudflare import cloudflare_authenticated_origin_pulls

    from terrascript.resource.cloudflare.cloudflare import cloudflare_authenticated_origin_pulls_certificate
    ...
    from terrascript.resource.cloudflare.cloudflare import cloudflare_custom_hostname_fallback_origin
    ...
    from terrascript.resource.cloudflare.cloudflare import cloudflare_device_posture_rule
    ...
    from terrascript.resource.cloudflare.cloudflare import cloudflare_load_balancer_monitor
    ...
    from terrascript.resource.cloudflare.cloudflare import cloudflare_logpush_ownership_challenge

    from terrascript.resource.cloudflare.cloudflare import cloudflare_magic_firewall_ruleset

    from terrascript.resource.cloudflare.cloudflare import cloudflare_origin_ca_certificate
    ...
    from terrascript.resource.cloudflare.cloudflare import cloudflare_spectrum_application
    ...
    from terrascript.resource.cloudflare.cloudflare import cloudflare_worker_cron_trigger
    ...
    from terrascript.resource.cloudflare.cloudflare import cloudflare_workers_kv_namespace
    ...
    from terrascript.resource.cloudflare.cloudflare import cloudflare_zone_settings_override




def test_datasource_import():
    from terrascript.data.cloudflare.cloudflare import cloudflare_api_token_permission_groups
