...
def test_resource_import():
    from terrascript.resource.hashicorp.googleworkspace import googleworkspace_chrome_policy

    from terrascript.resource.hashicorp.googleworkspace import googleworkspace_domain

    from terrascript.resource.hashicorp.googleworkspace import googleworkspace_domain_alias

    from terrascript.resource.hashicorp.googleworkspace import googleworkspace_gmail_send_as_alias

    from terrascript.resource.hashicorp.googleworkspace import googleworkspace_group

    from terrascript.resource.hashicorp.googleworkspace import googleworkspace_group_member

    from terrascript.resource.hashicorp.googleworkspace import googleworkspace_group_settings
    ...
    from terrascript.resource.hashicorp.googleworkspace import googleworkspace_role_assignment
...
def test_datasource_import():
    from terrascript.data.hashicorp.googleworkspace import googleworkspace_chrome_policy_schema
    ...
    from terrascript.data.hashicorp.googleworkspace import googleworkspace_group_settings
