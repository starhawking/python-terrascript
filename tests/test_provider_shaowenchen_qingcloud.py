...
def test_resource_import():
    ...
    from terrascript.resource.shaowenchen.qingcloud import qingcloud_loadbalancer_backend

    from terrascript.resource.shaowenchen.qingcloud import qingcloud_loadbalancer_listener
