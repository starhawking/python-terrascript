...
def test_resource_import():
    from terrascript.resource.datarootsio.kubeflowpipelines import kubeflowpipelines_experiment

    from terrascript.resource.datarootsio.kubeflowpipelines import kubeflowpipelines_job

    from terrascript.resource.datarootsio.kubeflowpipelines import kubeflowpipelines_pipeline
...
def test_datasource_import():
    from terrascript.data.datarootsio.kubeflowpipelines import kubeflowpipelines_experiment

    from terrascript.data.datarootsio.kubeflowpipelines import kubeflowpipelines_pipeline
