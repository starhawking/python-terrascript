...
def test_resource_import():
    ...
    from terrascript.resource.Mongey.confluentcloud import confluentcloud_schema_registry

    from terrascript.resource.Mongey.confluentcloud import confluentcloud_service_account
